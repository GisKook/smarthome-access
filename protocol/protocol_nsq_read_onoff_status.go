...
const CMD_READ_ONOFF_STATUS_LEN uint16 = 0x0014

type Nsq_Read_OnOff_Status_Packet struct {
	GatewayID uint64
	SerialNum uint32
	Status    byte
	DeviceID  uint64
...
func (p *Nsq_Read_OnOff_Status_Packet) SerializeOffline() []byte {
...
func (p *Nsq_Read_OnOff_Status_Packet) Serialize() []byte {
